...
const EPILOGUE = [
  ...
  '  pathLenMsg: pathLenMsg,',
  '  sanitizeEngineName: sanitizeEngineName,',
  '  vvBase: vvBase,',
  '  parseVvVoice: parseVvVoice,',
  '  applyVvTuning: applyVvTuning,',
  '  vvCharacterName: vvCharacterName,',
  '  voiceShortName: voiceShortName,',
  '  trackFor: trackFor,',
  '  partitionVoices: partitionVoices,',
  '  isFavVoice: isFavVoice,',
  '  toggleFavVoice: toggleFavVoice,',
  ...
  '    if(s.favVoices)      favVoices = s.favVoices;',
  '  }',
  '};'
].join('\n');
